...
"""
FastAPI application for the Quality Gate Env Environment.

This module creates an HTTP server that exposes the QualityGateEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    multiple workers:
        uvicorn quality_gate_env.server.app:app --workers 4
    """
    import uvicorn
